...
import StreamScreen from '@screens/Watch/stream/StreamScreen';
...
const StackNavigation = () => {
  ...
  return (
    <Stack.Navigator initialRouteName={Screens.Stack.LoginScreen}>
      ...
      <Stack.Screen
        options={{header: () => <NotificationsHeader />}}
      ...
      <Stack.Screen
        ...
        name={Screens.Stack.InboxScreen}
