...
const StreamItem = ({stream, customKey}: IProps) => {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.89}
      key={customKey}
      onPress={() => navigation.navigate(Screens.Stack.StreamScreen, {stream: stream})}>
      ...
      <View style={{marginLeft: 5}}>
        ...
        <Text ellipsizeMode="tail" style={styles.streamTitle}>
          {stream.streamTitle}
        </Text>
